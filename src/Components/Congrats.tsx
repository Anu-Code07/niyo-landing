...
import ResponsiveCarousel from "./Sick";
...
const Congrats = () => {
  ...
  return (
    <>
      <div className="bg-white p-6 flex flex-col items-center gap-6 h-screen w-screen ">
        <ConfettiExplosion {...bigExplodeProps} />
        <div className="text-center mt-8">
          <h1 className="text-3xl mb-5 font-bold text-[##333333] congs-text lg:text-6xl lg:mb-[80px]">
            Congratulations!!
          </h1>
          <h3 className="mt-6 font-semibold text-wrap lg:text-2xl lg:mb-[40px]">
              ...
              <div className="bg-[#F4F4F4] p-2 rounded-xl h-[158px] w-[250px] lg:h-[200px] lg:w-[307px] shadow-lg">
                <div className="box text-center h-full">
                  ...
                  <p className="text-sm text-[#0D0D0D] lg:text-[16px]">
                    Be the first to experience seamless transactions and
                    innovative solutions. We'll reach out when our product is
                    ready.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-[#F4F4F4] p-2 rounded-xl h-[158px] w-[250px] lg:h-[200px] lg:w-[307px] shadow-lg ">
                <div className="box text-center h-full">
                  ...
                  <p className="text-sm text-[#0D0D0D] lg:text-[16px] font-normal">
                    Keep an eye on your email for exclusive updates, early
                    access notifications, and exciting announcements.
                  </p>
                </div>
              </div>
            </div>
